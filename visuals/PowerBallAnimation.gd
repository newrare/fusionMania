# PowerBallAnimation - Visual animation of power ball traveling from enemy to tile
extends Node2D
...
static func create_animation(parent: Node, start_pos: Vector2, target_pos: Vector2):
	var PowerBallAnimationClass = preload("res://visuals/PowerBallAnimation.gd")
	var animation = PowerBallAnimationClass.new()
